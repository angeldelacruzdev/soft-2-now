  ...
  return (
    <section id="privacy">
      <div className="container justify-center flex flex-col items-center px-6 mx-auto mt-10 space-y-0 md:space-y-0 md:flex-col">
        <div className="prose lg:prose-xl w-3/4 mb-8">
          <h2>
            <b>PRIVACY POLICY</b>
          </h2>
          <p>Effective date: 2022-06-22</p>
          <p>
            1. <b>Introduction</b>
          </p>
          <p>
            Welcome to <b> Soft2now.com</b>.
          </p>
          <p>
            <b>Soft2now.com</b> (“us”, “we”, or “our”) operates{" "}
            <b>https://www.soft2now.com/</b> (hereinafter referred to as{" "}
            <b>“Service”</b>).
          </p>
          <p>
            Our Privacy Policy governs your visit to{" "}
            <b>https://www.soft2now.com/</b>, and explains how we collect,
          ...
          <p>
            <b>SERVICE</b> means the https://www.soft2now.com/ website operated
            by Soft2now.com.
          </p>
          <p>
          ...
          <p>Soft2now.com uses the collected data for various purposes:</p>
          ...
          <p>
            If you are located outside Dominican Republic and choose to provide
            information to us, please note that we transfer the data, including
            Personal Data, to Dominican Republic and process it there.
          </p>
          <p>
          ...
          <p>
            Soft2now.com will take all the steps reasonably necessary to ensure
          ...
          <p>
            ...
            us at <b>service@soft2now.com</b>.
          </p>
          ...
          <p>
            ...
            please send your request(s) by email: <b>service@soft2now.com</b>.
          </p>
          <p>
          ...
          <p>
            ...
            us by email: <b>service@soft2now.com</b>.
          </p>

          <span>Policies may change at any time.</span>
        </div>
      </div>
    </section>
  );
